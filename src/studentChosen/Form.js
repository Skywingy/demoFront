...
const Forms = () => {
    ...
    await axios({
        method: id ? "PUT" : "POST",
        url: id ? `/StudentChosen/${id}` : "/StudentChosen/create",
        data: data,
    });
    navigate('/user/StudentChosen');
    ...
    <div className="flex flex-col  p-2">
        ...
        <div className="text-sm font-semibold">Та энэ хичээлийг цуцлах уу?</div>
        </div>
        ...
        >
            ...
            <Form.Item label="Хичээлийн дугаар" name="lessoncode">
